                ...
                <div class="row col-md-10 col-12 offset-md-1">
                    <div class="col-md-3 col-12"><span class="category-title"> Shop by <strong>Category</strong></span>
                        ...
                        <div class="category-brand-container mb-3 mt-3 pl-1">
                            ...
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="JACKER" type="radio" class="custom-control-input" value="120"><label for="JACKER" class="custom-control-label">Jacker</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                            ...
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="LORENZ" type="radio" class="custom-control-input" value="1235"><label for="LORENZ" class="custom-control-label">Lorenz</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="M.C.M" type="radio" class="custom-control-input" value="4054"><label for="M.C.M" class="custom-control-label">M.c.m</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="MISTER POP" type="radio" class="custom-control-input" value="2437"><label for="MISTER POP" class="custom-control-label">Mister pop</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="MR POTATO" type="radio" class="custom-control-input" value="4066"><label for="MR POTATO" class="custom-control-label">Mr potato</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="MR.POP" type="radio" class="custom-control-input" value="2372"><label for="MR.POP" class="custom-control-label">Mr.pop</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="MUNCHEE" type="radio" class="custom-control-input" value="3954"><label for="MUNCHEE" class="custom-control-label">Munchee</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="NOAS" type="radio" class="custom-control-input" value="2645"><label for="NOAS" class="custom-control-label">Noas</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="ORIENTAL" type="radio" class="custom-control-input" value="1954"><label for="ORIENTAL" class="custom-control-label">Oriental</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="PREMERO" type="radio" class="custom-control-input" value="153"><label for="PREMERO" class="custom-control-label">Premero</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="PRIME NUTS" type="radio" class="custom-control-input" value="1859"><label for="PRIME NUTS" class="custom-control-label">Prime nuts</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="PRINGLES" type="radio" class="custom-control-input" value="2548"><label for="PRINGLES" class="custom-control-label">Pringles</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="RAMBA" type="radio" class="custom-control-input" value="2107"><label for="RAMBA" class="custom-control-label">Ramba</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="RANCRISP" type="radio" class="custom-control-input" value="802"><label for="RANCRISP" class="custom-control-label">Rancrisp</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="REAL TASTY" type="radio" class="custom-control-input" value="2008"><label for="REAL TASTY" class="custom-control-label">Real tasty</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="ROYAL CASHEW" type="radio" class="custom-control-input" value="3399"><label for="ROYAL CASHEW" class="custom-control-label">Royal cashew</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="SCAN" type="radio" class="custom-control-input" value="3110"><label for="SCAN" class="custom-control-label">Scan</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="TAI SUN" type="radio" class="custom-control-input" value="1919"><label for="TAI SUN" class="custom-control-label">Tai sun</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="TASTY" type="radio" class="custom-control-input" value="601"><label for="TASTY" class="custom-control-label">Tasty</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="TROPICAL NUT" type="radio" class="custom-control-input" value="3903"><label for="TROPICAL NUT" class="custom-control-label">Tropical nut</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="UMA" type="radio" class="custom-control-input" value="2429"><label for="UMA" class="custom-control-label">Uma</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="USWATTE" type="radio" class="custom-control-input" value="1298"><label for="USWATTE" class="custom-control-label">Uswatte</label></div>
                            </div>
                    ...
                    <div class="col-md-9 col-12">
                        ...
                        <?php 
                        include 'config.php';
                        $result = mysqli_query($con,"SELECT `category_id` FROM `categorys` WHERE `category_name`='snacks' ;");
...
<div class="col" style="padding-bottom: 15px;">
                                <div class="product-card-container">
                                    <div class="row">
                                        ...
                                        <div class="product-card-button-container col-md-12"><button type="button" class="product-card-button-add btn btn-primary btn-block">
