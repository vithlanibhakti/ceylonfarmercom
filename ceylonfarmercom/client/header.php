                ...
                <div class="col-md-10 col-12 offset-md-1">
                    <div class="upper-item-container row">
                        ...
                        <div class="nav-item nav-item-divider col-md-auto col-12"><i class="fas fa-truck"></i>Shipping Method
                            <div class="upper-nav-item-dropdown-container">Delivery</div>
                        </div>
                        <div class="nav-item logoutClass col-md-auto col-12"><i class="fas fa-sign-out-alt"></i>Log out</div>
                    </div>
                </div>
            </div>
            <div class="default-header-navbar">
                <div class="row col-md-10 offset-md-1">
                    <div class="col-lg-2 col-md-3">
                        <a href="https://www.keellssuper.com/home"><img src="/ceylonfarmercom/ceylonfarmercom/client/img/websitelogo.png" class="img-fluid"></a>
                    </div>
...
?>
 ...
 <div id="main"> 
   ...
   <div id="display"></div>
                                    ...
                                    <button class="product-search-button"><span>SEARCH PRODUCTS </span><i class="fas fa-search" style="padding-left: 0.625rem;"></i></button></div>
                            ...
                            <!-- <img src="/static/media/white-close-button.e47a6082.png" alt="menu-close_btn" class="category-menu-default-header-close-btn"> -->
                                <div class="category-menu-default-header-container">
                                    <ul class="category_menu_default_header-area">
                                        <li id="dep_id_16">Vegetables <span><i class="fa fa-angle-right"></i></span></li>
                                        <ul id="sub_dep_id_16" style="display: none;">
                                            <a href="/product/1/16">
                                                <li class="cat_item_" data-cat-id="all"><strong>All Vegetables</strong></li>
                                            </a>
                                        ...
                                        <ul id="sub_dep_id_2" style="display: none;">
                                            <a href="/product/1/2">
                                                <li class="cat_item_" data-cat-id="all"><strong>All Beverages</strong></li>
                                            </a>
                                        ...
                                        <ul id="sub_dep_id_3" style="display: none;">
                                            <a href="/product/1/3">
                                                <li class="cat_item_" data-cat-id="all"><strong>All Chilled</strong></li>
                                            </a>
                                        ...
                                        <li id="dep_id_5">Frozen Food <span><i class="fa fa-angle-right"></i></span></li>
                                        <ul id="sub_dep_id_5" style="display: none;">
                                            <a href="/product/1/5">
                                                <li class="cat_item_" data-cat-id="all"><strong>All Frozen Food</strong></li>
                                            </a>
                                        ...
                                        <ul id="sub_dep_id_7" style="display: none;">
                                            <a href="/product/1/7">
                                                <li class="cat_item_" data-cat-id="all"><strong>All Grocery</strong></li>
                                            </a>
                                        ...
                                        <ul id="sub_dep_id_8" style="display: none;">
                                            <a href="/product/1/8">
                                                <li class="cat_item_" data-cat-id="all"><strong>All Homeware</strong></li>
                                            </a>
                                        ...
                                        <ul id="sub_dep_id_9" style="display: none;">
                                            <a href="/product/1/9">
                                                <li class="cat_item_" data-cat-id="all"><strong>All Household</strong></li>
                                            </a>
                                        ...
                                        <ul id="sub_dep_id_11" style="display: none;">
                                            <a href="/product/1/11">
                                                <li class="cat_item_" data-cat-id="all"><strong>All Tobacco</strong></li>
                                            </a>
                                            <a href="/product/2/11/122">
                                                <li>Tobacco</li>
                                            </a>
                                        </ul>
                                        <li id="dep_id_13">Gift Voucher <span><i class="fa fa-angle-right"></i></span></li>
                                        <ul id="sub_dep_id_13" style="display: none;">
                                            <a href="/product/1/13">
                                                <li class="cat_item_" data-cat-id="all"><strong>All Gift Voucher</strong></li>
                                            </a>
                                        ...
                                        <ul id="sub_dep_id_14" style="display: none;">
                                            <a href="/product/1/14">
                                                <li class="cat_item_" data-cat-id="all"><strong>All Pharmacy</strong></li>
                                            </a>
                                        ...
                                        <li id="dep_id_15">Production Bakery <span><i class="fa fa-angle-right"></i></span></li>
                                        <ul id="sub_dep_id_15" style="display: none;">
                                            <a href="/product/1/15">
                                                <li class="cat_item_" data-cat-id="all"><strong>All Production Bakery</strong></li>
                                            </a>
