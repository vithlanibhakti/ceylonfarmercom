            ...
            <div class="m-0 row">
                <div class="col-lg-3 col-sm-12">
                    <div class="account-list-item-holder-active">
                        <a href="profile.php"><div>Profile Edit</div>
                        <i class="fas fa-chevron-right"></i>
</a></div>
                    <div class="account-list-item-holder">
                    <a href="shippingdetails.php"><div>Shipping Details</div>
                        <i class="fas fa-chevron-right"></i></a></div>
                    <div class="account-list-item-holder">
                    <a href="changepassword.php"><div>Change Password</div>
                        <i class="fas fa-chevron-right"></i>
</a></div>
                    <div class="account-list-item-holder">
                    ...
                    <div class="account-list-item-holder">
                    <a href="trackorderprofile.php"><div>Track My Order</div>
                        <i class="fas fa-chevron-right"></i></a></div>
                    <div class="account-list-item-holder">
                    <a href="utilityPayment.php"><div>Utility Bill Payments</div>
                        <i class="fas fa-chevron-right"></i></a></div>
                </div>
                <div class="col-lg-9 col-sm-12">
                    <div class="account-content-holder">
                        ...
                        <div class="col-lg-6 col-sm-12">
                            ...
                            <a href = "javascript:;" class="new-btn new-btn-primary" onclick = "this.href='updateprofile.php?firstName=' + document.getElementById('firstName').value+'&lastName='+ document.getElementById('lastName').value+'&dob='+ document.getElementById('dob').value+'&phoneNumber='+ document.getElementById('phoneNumber').value+'&contactNumber='+ document.getElementById('contactNumber').value+'&email='+ document.getElementById('emailAddress').value">Save</a>
