        ...
        <div>
            <div class="page-header-area" style="background-image: url(&quot;https://essstr.blob.core.windows.net/uiimg/PageHeader/ProductListingPageHeader.png&quot;);">
                <div id="page-header">
                    ...
                    <div class="row" style="margin: 0px;">
                        <div class="col-md-10 col-12 offset-md-1"><span>Homeware</span></div>
                    </div>
                </div>
            </div>
            <div class="row mt-3">
                ...
                <div class="row col-md-10 col-12 offset-md-1">
                    <div class="col-md-3 col-12"><span class="category-title"> Shop by <strong>Category</strong></span>
                        ...
                        <div class="category-container mb-1">
                            <div class="mb-1 category-item"><span>General Needs</span><i class="fas fa-angle-right"></i></div>
                            <div class="mb-1 category-item"><span>Kitchen Needs</span><i class="fas fa-angle-right"></i></div>
                            <div class="mb-1 category-item"><span>Kitchenware</span><i class="fas fa-angle-right"></i></div>
                            <div class="mb-1 category-item"><span>Plastic ware</span><i class="fas fa-angle-right"></i></div>
                            <div class="mb-1 category-item"><span>Stationary/Books</span><i class="fas fa-angle-right"></i></div>
                            <div class="mb-1 category-item"><span>Textile</span><i class="fas fa-angle-right"></i></div>
                            <div class="mb-1 category-item"><span>Tools</span><i class="fas fa-angle-right"></i></div>
                        ...
                        <div class="category-brand-container mb-3 mt-3 pl-1">
                            ...
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="AMRITHA" type="radio" class="custom-control-input" value="4395"><label for="AMRITHA" class="custom-control-label">Amritha</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="APSARA" type="radio" class="custom-control-input" value="90"><label for="APSARA" class="custom-control-label">Apsara</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="ATLAS" type="radio" class="custom-control-input" value="1525"><label for="ATLAS" class="custom-control-label">Atlas</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="BLACK &amp; GOLD" type="radio" class="custom-control-input" value="597"><label for="BLACK &amp; GOLD" class="custom-control-label">Black &amp; gold</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="BLACK &amp; WHITE" type="radio" class="custom-control-input" value="3272"><label for="BLACK &amp; WHITE" class="custom-control-label">Black &amp; white</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="BOND" type="radio" class="custom-control-input" value="3809"><label for="BOND" class="custom-control-label">Bond</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="BOSTIK" type="radio" class="custom-control-input" value="1511"><label for="BOSTIK" class="custom-control-label">Bostik</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="COMFOODS" type="radio" class="custom-control-input" value="1787"><label for="COMFOODS" class="custom-control-label">Comfoods</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="DIAMOND" type="radio" class="custom-control-input" value="456"><label for="DIAMOND" class="custom-control-label">Diamond</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="DIMO LUMIN" type="radio" class="custom-control-input" value="3313"><label for="DIMO LUMIN" class="custom-control-label">Dimo lumin</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="DPC" type="radio" class="custom-control-input" value="757"><label for="DPC" class="custom-control-label">Dpc</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="GARDN" type="radio" class="custom-control-input" value="2586"><label for="GARDN" class="custom-control-label">Gardn</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="GREEN HOUSE" type="radio" class="custom-control-input" value="4569"><label for="GREEN HOUSE" class="custom-control-label">Green house</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="HOMELUX" type="radio" class="custom-control-input" value="611"><label for="HOMELUX" class="custom-control-label">Homelux</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="HT" type="radio" class="custom-control-input" value="3963"><label for="HT" class="custom-control-label">Ht</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="IBIZA" type="radio" class="custom-control-input" value="2099"><label for="IBIZA" class="custom-control-label">Ibiza</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="IMPEXT" type="radio" class="custom-control-input" value="1759"><label for="IMPEXT" class="custom-control-label">Impext</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="JKC" type="radio" class="custom-control-input" value="4473"><label for="JKC" class="custom-control-label">Jkc</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="KEELLS" type="radio" class="custom-control-input" value="1207"><label for="KEELLS" class="custom-control-label">Keells</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="KEELLS GOOD" type="radio" class="custom-control-input" value="1217"><label for="KEELLS GOOD" class="custom-control-label">Keells good</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="KENT" type="radio" class="custom-control-input" value="1269"><label for="KENT" class="custom-control-label">Kent</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="KENTWAYS" type="radio" class="custom-control-input" value="407"><label for="KENTWAYS" class="custom-control-label">Kentways</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="KEVILTON" type="radio" class="custom-control-input" value="4492"><label for="KEVILTON" class="custom-control-label">Kevilton</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="LANKA SUMEDA" type="radio" class="custom-control-input" value="2073"><label for="LANKA SUMEDA" class="custom-control-label">Lanka sumeda</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="LION STAR" type="radio" class="custom-control-input" value="791"><label for="LION STAR" class="custom-control-label">Lion star</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="M.B.M." type="radio" class="custom-control-input" value="3232"><label for="M.B.M." class="custom-control-label">M.b.m.</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="MAPED" type="radio" class="custom-control-input" value="3871"><label for="MAPED" class="custom-control-label">Maped</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="MBM" type="radio" class="custom-control-input" value="34"><label for="MBM" class="custom-control-label">Mbm</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="MEGA" type="radio" class="custom-control-input" value="2137"><label for="MEGA" class="custom-control-label">Mega</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="MULTIBOND" type="radio" class="custom-control-input" value="4298"><label for="MULTIBOND" class="custom-control-label">Multibond</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="NATARAJ" type="radio" class="custom-control-input" value="303"><label for="NATARAJ" class="custom-control-label">Nataraj</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="NEOMED" type="radio" class="custom-control-input" value="629"><label for="NEOMED" class="custom-control-label">Neomed</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="ORANGE" type="radio" class="custom-control-input" value="4588"><label for="ORANGE" class="custom-control-label">Orange</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="PANASONIC" type="radio" class="custom-control-input" value="912"><label for="PANASONIC" class="custom-control-label">Panasonic</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="PENGUIN" type="radio" class="custom-control-input" value="2659"><label for="PENGUIN" class="custom-control-label">Penguin</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="PILANA" type="radio" class="custom-control-input" value="1854"><label for="PILANA" class="custom-control-label">Pilana</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="PLUS" type="radio" class="custom-control-input" value="4234"><label for="PLUS" class="custom-control-label">Plus</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="PREMIUM" type="radio" class="custom-control-input" value="3210"><label for="PREMIUM" class="custom-control-label">Premium</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="PROMATE" type="radio" class="custom-control-input" value="3929"><label for="PROMATE" class="custom-control-label">Promate</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="RICHY" type="radio" class="custom-control-input" value="1667"><label for="RICHY" class="custom-control-label">Richy</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="RISANDU" type="radio" class="custom-control-input" value="545"><label for="RISANDU" class="custom-control-label">Risandu</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="ROTOMAC" type="radio" class="custom-control-input" value="3525"><label for="ROTOMAC" class="custom-control-label">Rotomac</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="RUSIRU" type="radio" class="custom-control-input" value="1033"><label for="RUSIRU" class="custom-control-label">Rusiru</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="SAMILA" type="radio" class="custom-control-input" value="3123"><label for="SAMILA" class="custom-control-label">Samila</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="SHAKTHI" type="radio" class="custom-control-input" value="3130"><label for="SHAKTHI" class="custom-control-label">Shakthi</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="SHENGLI" type="radio" class="custom-control-input" value="2058"><label for="SHENGLI" class="custom-control-label">Shengli</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="SOORYA" type="radio" class="custom-control-input" value="4007"><label for="SOORYA" class="custom-control-label">Soorya</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="THAI SUMEDA" type="radio" class="custom-control-input" value="3337"><label for="THAI SUMEDA" class="custom-control-label">Thai sumeda</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="YP" type="radio" class="custom-control-input" value="2966"><label for="YP" class="custom-control-label">Yp</label></div>
                            </div>
                            <div class="custom-controls-stacked">
                                <div class="custom-control custom-radio mb-2"><input name="rdoBrands" id="ZIP" type="radio" class="custom-control-input" value="3032"><label for="ZIP" class="custom-control-label">Zip</label></div>
                            </div>
                    ...
                    <div class="col-md-9 col-12">
                        ...
                        <?php 
                        include 'config.php';
                        $result = mysqli_query($con,"SELECT `category_id` FROM `categorys` WHERE `category_name`='Home Items' ;");
                        while($row = mysqli_fetch_array($result)) 
                        {
                                    $category_id= $row['category_id'];    
                                   // echo $category_id;
                                    $result1 = mysqli_query($con,"SELECT  `p_id`,`p_name`, `p_image` FROM `products` WHERE `category_id`=$category_id;");                                    
