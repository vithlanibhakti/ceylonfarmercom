...
<?php include("header.php"); ?>
        <div class="page-header-area" style="background-image: url(&quot;https://essstr.blob.core.windows.net/uiimg/PageHeader/ProductListingPageHeader.png&quot;);">
                <div id="page-header">
                    ...
                    <div class="row" style="margin: 0px;">
                        <div class="col-md-10 col-12 offset-md-1"><span>Vegetables</span></div>
                    </div>
                </div>
            </div>
            <div class="row mt-3">
                ...
                <div class="row col-md-10 col-12 offset-md-1">
                    <div class="col-md-3 col-12"><span class="category-title"> Shop by <strong>Category</strong></span>
                        ...
                        <div class="category-container mb-1">
                            <div class="mb-1 category-item"><span>Exotic</span><i class="fas fa-angle-right"></i></div>
                            <div class="mb-1 category-item"><span>Low Country Vegetables</span><i class="fas fa-angle-right"></i></div>
                            <div class="mb-1 category-item"><span>Organic</span><i class="fas fa-angle-right"></i></div>
                            <div class="mb-1 category-item"><span>Packets &amp; Units</span><i class="fas fa-angle-right"></i></div>
                            <div class="mb-1 category-item"><span>Pola</span><i class="fas fa-angle-right"></i></div>
                            <div class="mb-1 category-item"><span>Up Country Vegetables</span><i class="fas fa-angle-right"></i></div>
                        ...
                        <div class="m-0 row-cols-2 row-cols-xs-2 row-cols-sm-3 row-cols-md-3 row-cols-lg-4 row">
                            <div class="col" style="padding-bottom: 15px;">
                                <div class="product-card-container">
                                    <div class="row">
                                        <div class="product-card-image-container col-md-12"><img class="img-fluid" src="https://essstr.blob.core.windows.net/essimg/350x/Small/Pic916002.jpg"></div>
                                        <div class="product-card-name col-md-12">Ambarella</div>
                                        <div class="product-card-price-container col-md-12">
                                            <div class="product-card-final-price">Rs 160.00 / KG</div>
                                        </div>
                            ...
                            <div class="col" style="padding-bottom: 15px;">
                                <div class="product-card-container">
                                    <div class="row">
                                        <div class="product-card-image-container col-md-12"><img class="img-fluid" src="https://essstr.blob.core.windows.net/essimg/350x/Small/Pic913014.jpg"></div>
                                        <div class="product-card-name col-md-12">Cauliflower</div>
                                        <div class="product-card-price-container col-md-12">
                                            <div class="product-card-final-price">Rs 550.00 / KG</div>
                                        </div>
                                        <div class="product-card-button-container col-md-12"><button type="button" class="product-card-button-add btn btn-primary btn-block"><i class="fas fa-shopping-cart"></i>Add to Cart</button></div>
                                    </div>
                                </div>
                            ...
                            <div class="col" style="padding-bottom: 15px;">
                                <div class="product-card-container">
                                    <div class="row">
                                        <div class="product-card-image-container col-md-12"><img class="img-fluid" src="https://essstr.blob.core.windows.net/essimg/350x/Small/Pic912006.jpg"></div>
                                        <div class="product-card-name col-md-12">Corn (Bada Iringu)</div>
                                        <div class="product-card-price-container col-md-12">
                                            <div class="product-card-final-price">Rs 27.00 / Unit</div>
                                        </div>
                                        <div class="product-card-button-container col-md-12"><button type="button" class="product-card-button-add btn btn-primary btn-block"><i class="fas fa-shopping-cart"></i>Add to Cart</button></div>
                                    </div>
                                </div>
                            ...
                            <div class="col" style="padding-bottom: 15px;">
                                <div class="product-card-container">
                                    <div class="row">
                                        <div class="product-card-image-container col-md-12"><img class="img-fluid" src="https://essstr.blob.core.windows.net/essimg/350x/Small/Pic914010.jpg"></div>
                                        <div class="product-card-name col-md-12">Curry Leaves</div>
                                        <div class="product-card-price-container col-md-12">
                                            <div class="product-card-final-price">Rs 170.00 / KG</div>
                                        </div>
                                        <div class="product-card-button-container col-md-12"><button type="button" class="product-card-button-add btn btn-primary btn-block"><i class="fas fa-shopping-cart"></i>Add to Cart</button></div>
                                    </div>
                                </div>
                            ...
                            <div class="col" style="padding-bottom: 15px;">
                                <div class="product-card-container">
                                    <div class="row">
                                        <div class="product-card-image-container col-md-12"><img class="img-fluid" src="https://essstr.blob.core.windows.net/essimg/350x/Small/Pic914011.jpg"></div>
                                        <div class="product-card-name col-md-12">Dambala</div>
                                        <div class="product-card-price-container col-md-12">
                                            <div class="product-card-final-price">Rs 290.00 / KG</div>
                                        </div>
                                        <div class="product-card-button-container col-md-12"><button type="button" class="product-card-button-add btn btn-primary btn-block"><i class="fas fa-shopping-cart"></i>Add to Cart</button></div>
                                    </div>
                                </div>
                            ...
                            <div class="col" style="padding-bottom: 15px;">
                                <div class="product-card-container">
                                    <div class="row">
                                        <div class="product-card-image-container col-md-12"><img class="img-fluid" src="https://essstr.blob.core.windows.net/essimg/350x/Small/Pic914018.jpg"></div>
                                        <div class="product-card-name col-md-12">Green Cucumber</div>
                                        <div class="product-card-price-container col-md-12">
                                            <div class="product-card-final-price">Rs 140.00 / KG</div>
                                        </div>
                                        <div class="product-card-button-container col-md-12"><button type="button" class="product-card-button-add btn btn-primary btn-block"><i class="fas fa-shopping-cart"></i>Add to Cart</button></div>
                                    </div>
                                </div>
                            ...
                            <div class="col" style="padding-bottom: 15px;">
                                <div class="product-card-container">
                                    <div class="row">
                                        <div class="product-card-image-container col-md-12"><img class="img-fluid" src="https://essstr.blob.core.windows.net/essimg/350x/Small/Pic914021.jpg"></div>
                                        <div class="product-card-name col-md-12">Kekiri</div>
                                        <div class="product-card-price-container col-md-12">
                                            <div class="product-card-final-price">Rs 80.00 / KG</div>
                                        </div>
                                        <div class="product-card-button-container col-md-12"><button type="button" class="product-card-button-add btn btn-primary btn-block"><i class="fas fa-shopping-cart"></i>Add to Cart</button></div>
                                    </div>
                                </div>
                            ...
                            <div class="col" style="padding-bottom: 15px;">
                                <div class="product-card-container">
                                    <div class="row">
                                        <div class="product-card-image-container col-md-12"><img class="img-fluid" src="https://essstr.blob.core.windows.net/essimg/350x/Small/Pic915010.jpg"></div>
                                        <div class="product-card-name col-md-12">Knol Khol</div>
                                        <div class="product-card-price-container col-md-12">
                                            <div class="product-card-final-price">Rs 260.00 / KG</div>
                                        </div>
                                        <div class="product-card-button-container col-md-12"><button type="button" class="product-card-button-add btn btn-primary btn-block"><i class="fas fa-shopping-cart"></i>Add to Cart</button></div>
                                    </div>
                                </div>
                            ...
                            <div class="col" style="padding-bottom: 15px;">
                                <div class="product-card-container">
                                    <div class="row">
                                        <div class="product-card-image-container col-md-12"><img class="img-fluid" src="https://essstr.blob.core.windows.net/essimg/350x/Small/Pic914030.jpg"></div>
                                        <div class="product-card-name col-md-12">Long Beans</div>
                                        <div class="product-card-price-container col-md-12">
                                            <div class="product-card-final-price">Rs 190.00 / KG</div>
                                        </div>
                                        <div class="product-card-button-container col-md-12"><button type="button" class="product-card-button-add btn btn-primary btn-block"><i class="fas fa-shopping-cart"></i>Add to Cart</button></div>
                                    </div>
                                </div>
                            ...
                            <div class="col" style="padding-bottom: 15px;">
                                <div class="product-card-container">
                                    <div class="row">
                                        <div class="product-card-image-container col-md-12"><img class="img-fluid" src="https://essstr.blob.core.windows.net/essimg/350x/Small/Pic916029.jpg"></div>
                                        <div class="product-card-name col-md-12">Manioc</div>
                                        <div class="product-card-price-container col-md-12">
                                            <div class="product-card-final-price">Rs 160.00 / KG</div>
                                        </div>
                                        <div class="product-card-button-container col-md-12"><button type="button" class="product-card-button-add btn btn-primary btn-block"><i class="fas fa-shopping-cart"></i>Add to Cart</button></div>
                            ...
                            <div class="col" style="padding-bottom: 15px;">
                                <div class="product-card-container">
                                    <div class="row">
                                        <div class="product-card-image-container col-md-12"><img class="img-fluid" src="https://essstr.blob.core.windows.net/essimg/350x/Small/Pic913055.jpg"></div>
                                        <div class="product-card-name col-md-12">Minchi Leaves</div>
                                        <div class="product-card-price-container col-md-12">
                                            <div class="product-card-final-price">Rs 550.00 / KG</div>
                                        </div>
                                        <div class="product-card-button-container col-md-12"><button type="button" class="product-card-button-add btn btn-primary btn-block"><i class="fas fa-shopping-cart"></i>Add to Cart</button></div>
                            ...
                            <div class="col" style="padding-bottom: 15px;">
                                <div class="product-card-container">
                                    <div class="row">
                                        <div class="product-card-image-container col-md-12"><img class="img-fluid" src="https://essstr.blob.core.windows.net/essimg/350x/Small/Pic912056.jpg"></div>
                                        <div class="product-card-name col-md-12">Nature Harvest Button Mushroom 200g</div>
                                        <div class="product-card-price-container col-md-12">
                                            <div class="product-card-final-price">Rs 350.00 / Unit</div>
                                        </div>
                                        <div class="product-card-button-container col-md-12"><button type="button" class="product-card-button-add btn btn-primary btn-block"><i class="fas fa-shopping-cart"></i>Add to Cart</button></div>
                                    </div>
                                </div>
                            ...
                            <div class="col" style="padding-bottom: 15px;">
                                <div class="product-card-container">
                                    <div class="row">
                                        <div class="product-card-image-container col-md-12"><img class="img-fluid" src="https://essstr.blob.core.windows.net/essimg/350x/Small/Pic911041.jpg"></div>
                                        <div class="product-card-name col-md-12">Organic Green Beans</div>
                                        <div class="product-card-price-container col-md-12">
                                            <div class="product-card-final-price">Rs 560.00 / KG</div>
                                        </div>
                                        <div class="product-card-button-container col-md-12"><button type="button" class="product-card-button-add btn btn-primary btn-block"><i class="fas fa-shopping-cart"></i>Add to Cart</button></div>
                                    </div>
                                </div>
                            ...
                            <div class="col" style="padding-bottom: 15px;">
                                <div class="product-card-container">
                                    <div class="row">
                                        <div class="product-card-image-container col-md-12"><img class="img-fluid" src="https://essstr.blob.core.windows.net/essimg/350x/Small/Pic914044.jpg"></div>
                                        <div class="product-card-name col-md-12">Ribbed Gourd</div>
                                        <div class="product-card-price-container col-md-12">
                                            <div class="product-card-final-price">Rs 160.00 / KG</div>
                                        </div>
                                        <div class="product-card-button-container col-md-12"><button type="button" class="product-card-button-add btn btn-primary btn-block"><i class="fas fa-shopping-cart"></i>Add to Cart</button></div>
                            ...
                            <div class="col" style="padding-bottom: 15px;">
                                <div class="product-card-container">
                                    <div class="row">
                                        <div class="product-card-image-container col-md-12"><img class="img-fluid" src="https://essstr.blob.core.windows.net/essimg/350x/Small/Pic914047.jpg"></div>
                                        <div class="product-card-name col-md-12">Snake Gourd</div>
                                        <div class="product-card-price-container col-md-12">
                                            <div class="product-card-final-price">Rs 150.00 / KG</div>
                                        </div>
                                        <div class="product-card-button-container col-md-12"><button type="button" class="product-card-button-add btn btn-primary btn-block"><i class="fas fa-shopping-cart"></i>Add to Cart</button></div>
                                    </div>
                                </div>
                            ...
                            <div class="col" style="padding-bottom: 15px;">
                                <div class="product-card-container">
                                    <div class="row">
                                        <div class="product-card-image-container col-md-12"><img class="img-fluid" src="https://essstr.blob.core.windows.net/essimg/350x/Small/Pic912108.jpg"></div>
                                        <div class="product-card-name col-md-12">White Wave Tofu( Bean Curd )250g</div>
                                        <div class="product-card-price-container col-md-12">
                                            <div class="product-card-final-price">Rs 145.00 / Unit</div>
                                        </div>
                                        <div class="product-card-button-container col-md-12"><button type="button" class="product-card-button-add btn btn-primary btn-block"><i class="fas fa-shopping-cart"></i>Add to Cart</button></div>
                                    </div>
                                </div>
                            ...
                            <div class="col" style="padding-bottom: 15px;">
                                <div class="product-card-container">
                                    <div class="row">
                                        <div class="product-card-image-container col-md-12"><img class="img-fluid" src="https://essstr.blob.core.windows.net/essimg/350x/Small/Pic913007.jpg"></div>
                                        <div class="product-card-name col-md-12">Bell Pepper Yellow</div>
                                        <div class="product-card-price-container col-md-12">
                                            <div class="product-card-final-price">Rs 910.00 / KG</div>
                                        </div>
                                        <div class="product-card-button-container col-md-12"><button type="button" class="product-card-button-add btn btn-primary btn-block"><i class="fas fa-shopping-cart"></i>Add to Cart</button></div>
                                    </div>
                                </div>
                            ...
                            <div class="col" style="padding-bottom: 15px;">
                                <div class="product-card-container">
                                    <div class="row">
                                        <div class="product-card-image-container col-md-12"><img class="img-fluid" src="https://essstr.blob.core.windows.net/essimg/350x/Small/Pic913005.jpg"></div>
                                        <div class="product-card-name col-md-12">Bell Pepper Green</div>
                                        <div class="product-card-price-container col-md-12">
                                            <div class="product-card-final-price">Rs 510.00 / KG</div>
                                        </div>
                                        <div class="product-card-button-container col-md-12"><button type="button" class="product-card-button-add btn btn-primary btn-block"><i class="fas fa-shopping-cart"></i>Add to Cart</button></div>
                                    </div>
                                </div>
                            ...
                            <div class="col" style="padding-bottom: 15px;">
                                <div class="product-card-container">
                                    <div class="row">
                                        <div class="product-card-image-container col-md-12"><img class="img-fluid" src="https://essstr.blob.core.windows.net/essimg/350x/Small/Pic913066.jpg"></div>
                                        <div class="product-card-name col-md-12">Salad Cucumber</div>
                                        <div class="product-card-price-container col-md-12">
                                            <div class="product-card-final-price">Rs 210.00 / KG</div>
                                        </div>
                                        <div class="product-card-button-container col-md-12"><button type="button" class="product-card-button-add btn btn-primary btn-block"><i class="fas fa-shopping-cart"></i>Add to Cart</button></div>
                                    </div>
                                </div>
                            ...
                            <div class="col" style="padding-bottom: 15px;">
                                <div class="product-card-container">
                                    <div class="row">
                                        <div class="product-card-image-container col-md-12"><img class="img-fluid" src="https://essstr.blob.core.windows.net/essimg/350x/Small/Pic912022.jpg"></div>
                                        <div class="product-card-name col-md-12">Fresh Leaf Gotukola 100g</div>
                                        <div class="product-card-price-container col-md-12">
